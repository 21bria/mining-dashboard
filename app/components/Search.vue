  ...
  <CommandDialog v-model:open="openCommand">
    ...
    <CommandList>
      ...
      <CommandGroup heading="Suggestions">
        ...
        <CommandItem value="inventory" @select="handleSelectLink('/components/inventory/data-all')">
          Inventory
          <CommandShortcut>
            <Kbd>G</Kbd>
            <Kbd>I</Kbd>
        ...
        <CommandItem value="chart" @select="handleSelectLink('/components/coa/analysis')">
          Chart COA
          <CommandShortcut>
            <Kbd>G</Kbd>
            <Kbd>C</Kbd>
        ...
        <CommandSeparator />
        <CommandItem value="kpi" @select="handleSelectLink('/mining/unit-status')">
          Mining KPI
          <CommandShortcut>
            <Kbd>M</Kbd>
            <Kbd>K</Kbd>
        ...
        <CommandItem value="mining" @select="handleSelectLink('/mining/daily-report')">
          Mining Daily
          <CommandShortcut>
            <Kbd>M</Kbd>
            <Kbd>D</Kbd>
