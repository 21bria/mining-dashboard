...
async function fetchChartData() {
  try {
    ...
    chartData.value = {
      ...
      series: [
        { name: 'Production In', type: chartTypeConfig.value.stock, data: data.y_sap_in ?? [] },
        { name: 'Selling', type: chartTypeConfig.value.selling, data: data.y_sap_out ?? [] },
        { name: 'Stock Opname', type: chartTypeConfig.value.balance, data: data.y_sap_balance ?? [] }
      ]
    }
  } catch (error) {
