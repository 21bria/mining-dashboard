...
<template>
    <div class="w-full flex flex-col gap-4">
        <div class="mb-2">
            ...
            <button @click="$router.push('/mining/daily-report')" class="text-sm text-blue-500 underline">
                ← Back to Daily
            </button>
        </div>
        <!-- Tombol Kembali -->
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <Card class="xxl:col-span-12 xl:col-span-12 col-span-12 px-2 w-full overflow-hidden">
                            ...
                            <CardContent class="pl-2 overflow-hidden overflow-x-auto">
                                <DailyMiningOreMovement material="ore" @update:grandTotal="val => (grandTotal = val)" />
                            </CardContent>
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <div class="xl:col-span-12 col-span-12">
                            <Card class="h-full w-full overflow-hidden">
                                ...
                                <CardContent class="pl-2 overflow-hidden overflow-x-auto">
                                    <DailyMiningTopSoilMovement material="top_soil"
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <div class="xl:col-span-12 col-span-12">
                            <Card class="h-full w-full overflow-hidden">
                                ...
                                <CardContent class="pl-2 overflow-hidden overflow-x-auto">
                                    <DailyMiningObMovement material="ob"
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <div class="xl:col-span-12 col-span-12">
                            <Card class="h-full w-full overflow-hidden">
                                ...
                                <CardContent class="pl-2 overflow-hidden overflow-x-auto">
                                    <DailyMiningWasteMovement material="waste"
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <div class="xl:col-span-12 col-span-12">
                            <Card class="h-full w-full overflow-hidden">
                                ...
                                <CardContent class="pl-2 overflow-hidden overflow-x-auto">
                                    <DailyMiningQuarryMovement material="quarry"
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <div class="xl:col-span-12 col-span-12">
                            <Card class="h-full w-full overflow-hidden">
                                ...
                                <CardContent class="pl-2 overflow-hidden overflow-x-auto">
                                    <Daily-MiningOthersMovement material="others"
