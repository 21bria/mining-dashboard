<template>
  <div class="w-full flex flex-col gap-4">
    ...
    <div class="mb-2 flex items-center justify-between">
      <div>
        <h1 class="text-xl font-bold text-gray-900 dark:text-white">Detail Finish Inventory</h1>
          ...
          <Table>
            ...
            <TableBody>
              <TableRow v-for="dome in domes" :key="dome.pile_id">
                <TableCell>{{ dome.pile_id }}</TableCell>
...
async function fetchInventory() {
  ...
  params.append('saleFilter', saleFilter.value)
    ...
    const url = `${URL_GET_DATA}dashboard/api/inventory-finish/?${params.toString()}`
...
watch([saleFilter, areaFilter, pointFilter, page], fetchInventory, { immediate: true })
</script>
