<template>
  <div class="w-full flex flex-col gap-4">
    ...
    <div class="mb-2 flex items-center justify-between">
      <div>
        <h1 class="text-xl font-bold text-gray-900 dark:text-white">Inventory Limonite</h1>
    ...
    <Card class="w-full overflow-x-auto mt-6">
      <CardHeader>
        <CardTitle>Dome Limonite</CardTitle>
      </CardHeader>
      <CardContent>
...
async function fetchInventory() {
  ...
  try {
    ...
    const url = `${URL_GET_DATA}dashboard/api/inventory-lim/?${params.toString()}`
